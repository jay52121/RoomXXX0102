...
* **变更摘要**
  ...
  * 验证：现有及新增单元测试合计 45 项通过，其中 PortalV3CoreTest 31 项；:app:assembleDebug 通过；仅 arm64-v8a；两套 w8a32 资产 SHA256 与改造前一致。
  * 安装包：128171337 字节，较前版变化 +114688 字节；SHA256 b3665956413826b06851e2f8c742722fd9a263d3bc6eb09e033bc9d6bc139d7d。
